...
\begin{center}
\includegraphics[keepaspectratio=true]{Oscillations1.png}
\end{center}
...
\begin{center}
\includegraphics[keepaspectratio=true]{Errors.png}
\end{center}
...
\begin{center}
\includegraphics[keepaspectratio=true]{Error-H.png}
\end{center}
...
\begin{center}
\includegraphics[keepaspectratio=true,width=360pt]{Energy.png}
\end{center}
...
\begin{center}
\includegraphics[keepaspectratio=true,width=360pt]{ErrorCombination.png}
\end{center}
...
\begin{center}
\includegraphics[keepaspectratio=true,width=360pt]{Implicit.png}
\end{center}
